			...
			<table class="form-container" width="100%" border="0" cellspacing="0"
				...
				<tr>
					...
					<td valign="middle" class="field-bg" width="40%">
						<input type="radio" class="radio-button" name="agreeRights" id="agreeRightsY" value="y" ${info.agreeRights == 'y' ? 'checked' : ''} />
						...
						<input type="radio" class="radio-button" name="agreeRights" id="agreeRightsN" value="n" ${info.agreeRights != 'y' ? 'checked' : ''} /> 
