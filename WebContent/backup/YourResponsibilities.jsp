...
<script src="js/YourResponsibilities.js" type="text/javascript"></script>
...
<body onload = "fnYourRespOnLoad()" onunload = "fnYourRespOnUnLoad()">
<form id="YourResponsibilitiesForm" name="YourResponsibilitiesForm" method="post" action="ReleaseOfInformation.jsp">
...
<tr>
<td valign="middle" class="label-bg">I know that I must tell the program I'll be enrolled in if information I listed on this application changes. I know I can make changes by calling customer service and that I must report by the fifth (5th) of the following month. I understand that a change in my information could affect my eligibility for member(s) of my household. </td>
</tr>
<tr id="agreeDisagree">
<td valign="middle" class="field-bg">
<input type="radio"  class="radio-button" name = "agreeYourResp" id="agreeYourResp"/>
<label for="radio5"> <b>Agree: </b> During the telephone application process, you accepted and agreed to the above terms</label><br>
<input type="radio"  class="radio-button" name = "agreeYourResp" id="disAgreeYourResp"/>
...
<tr>
<td valign="top"><a href="VoterRegistration.jsp"></a><a href="index.jsp"><img src="images/exit-icon2.png" width="29" height="50" alt=""/></a></td>
<td align="right" valign="top">
<button type="button" name="previous-arrow" onclick = "window.location='YourRights.jsp'">
