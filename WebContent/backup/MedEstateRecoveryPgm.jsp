...
<script src="js/MedEstateRecoveryPgm.js"></script>
...
<body onload ="fnMedEstateRecoveryPgmOnLoad()" onload = "fnMedEstateRecoveryPgmOnUnLoad()">
<form id="MedEstateRecoveryForm" name="MedEstateRecoveryForm" method="post" action="ThirdPartyLiability.jsp">
...
<tr>
<td valign="middle" class="label-bg">Medicaid recipients who are 55 years or older or inpatients of a medical facility may be responsible for repayment of Medicaid expenses paid for them.  Recovery of these payments made from the Medicaid Program would be pursued from the estate of the recipient after their death or after the death of their surviving spouse.  (See Form 6160-AF, Program Operation.)</td>
</tr>
<tr id="agreeDisagree">
<td valign="middle" class="field-bg">
<input type="radio"  class="radio-button" name = "agreeMedEstate" id="agreeMedEstate"/>
<label for="radio5"> <b>Agree:</b> During the telephone application process, you accepted and agreed to the above terms</label><br>
<input type="radio"  class="radio-button" name = "agreeMedEstate" id="disAgreeMedEstate"/>
...
<button type="button" name="previous-arrow" onclick = "window.location='AuthRep.jsp'">
