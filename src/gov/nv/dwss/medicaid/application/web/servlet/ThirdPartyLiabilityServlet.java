...
/**
 * Servlet implementation class ThirdPartyLiabilityServlet
 */
public class ThirdPartyLiabilityServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("ThirdPartyLiability.jsp").forward(request, response);
	}
