...
public class DeductionsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		deductions.setHaveDeductions(FormatHelpers.formatBool(request.getParameter("haveDeductions")));
		...
		educatorExp.setAmount(FormatHelpers.formatMoney(request.getParameter("educatorExpensesAmt")));
		...
		healthSavings.setAmount(FormatHelpers.formatMoney(request.getParameter("healthSavingsAmt")));
		...
		movingExp.setAmount(FormatHelpers.formatMoney(request.getParameter("movingExpAmt")));
		...
		ira.setAmount(FormatHelpers.formatMoney(request.getParameter("IRAAmt")));
		...
		businessExp.setAmount(FormatHelpers.formatMoney(request.getParameter("businessExpAmt")));
		...
		penaltyPaid.setAmount(FormatHelpers.formatMoney(request.getParameter("penaltyPaidAmt")));
		...
		studentLoanInt.setAmount(FormatHelpers.formatMoney(request.getParameter("studentLoanIntAmt")));
		...
		tuition.setAmount(FormatHelpers.formatMoney(request.getParameter("tuitionAmt")));
		...
		domesticProdAct.setAmount(FormatHelpers.formatMoney(request.getParameter("domesticProdActAmt")));
